...
system_prompt = open('./V1_Prompts/system_prompt_with_payoffs_and_rules.txt', 'r').read()
initial_prompt = open('/./V1_Prompts/intro_user_prompt.txt', 'r').read()
follow_up_prompt_1st = open('./V1_Prompts/follow_up_user_prompt_first_part.txt', 'r').read()
follow_up_prompt_2nd = open('./V1_Prompts/follow_up_user_prompt_intermediate.txt', 'r').read()
